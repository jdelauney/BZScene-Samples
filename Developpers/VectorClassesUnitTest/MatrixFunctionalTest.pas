...
type
  ...
  private
    ...
    function OddPosition(Pos: Integer; AValue: Single): TBZMatrix4f;
    { similar to above but alters 2x2 portion of the matrix
     Pos 1 to 9 top left to bottom right in left -> right top -> bottom order}
    function OddTwoByTwo(Pos: Integer; AValue: Single): TBZMatrix4f;
  protected
    procedure Setup; override;
  public
    {$CODEALIGN RECORDMIN=16}
    mKnownDet, invKnown, ResMat: TBZMatrix4f;       // has det of -50
    mtx1, mtx2, mtx3, mtx4 : TBZMatrix4f;
    aqt1 : TBZQuaternion;
    apl1 : TBZHmgPlane;
...
const
  ...
  M_LOWER_LEFT_1_9 : TBZMatrix = (V:(
                                      (X:1; Y:1; Z:1; W:1),
                                      (X:1; Y:2; Z:3; W:1),
                                      (X:4; Y:5; Z:6; W:1),
                                      (X:7; Y:8; Z:9; W:1)
                                      ));
  M_UPPER_LEFT_1_9 : TBZMatrix = (V:(
                                      (X:1; Y:2; Z:3; W:1),
                                      (X:4; Y:5; Z:6; W:1),
                                      (X:7; Y:8; Z:9; W:1),
                                      (X:1; Y:1; Z:1; W:1)
                                      ));
  M_LOWER_RIGHT_1_9 : TBZMatrix = (V:(
                                      (X:1; Y:1; Z:1; W:1),
                                      (X:1; Y:1; Z:2; W:3),
                                      (X:1; Y:4; Z:5; W:6),
                                      (X:1; Y:7; Z:8; W:9)
                                      ));
  M_UPPER_RIGHT_1_9 : TBZMatrix = (V:(
                                      (X:1; Y:1; Z:2; W:3),
                                      (X:1; Y:4; Z:5; W:6),
                                      (X:1; Y:7; Z:8; W:9),
                                      (X:1; Y:1; Z:1; W:1)
...
function TMatrixFunctionalTest.OddPosition(Pos: Integer; AValue: Single): TBZMatrix4f;
begin
...
function TMatrixFunctionalTest.OddTwoByTwo(Pos: Integer; AValue: Single): TBZMatrix4f;
begin
  Result.V[0].Create(1, 2, 2, 4);  // interesting matrix this, inverse
  Result.V[1].Create(2, 1, 4, 2);  // is 0 point value reoccuring
  Result.V[2].Create(2, 4, 1, 2);
