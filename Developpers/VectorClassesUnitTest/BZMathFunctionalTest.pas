...
procedure TBZMathFunctionalTest.TestNormalizeDegAngle;
begin
...
procedure TBZMathFunctionalTest.TestNormalizeRadAngle;
begin
...
initialization
  RegisterTest(REPORT_GROUP_BASE, TBZMathFunctionalTest);
end.
