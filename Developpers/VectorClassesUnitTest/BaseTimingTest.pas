...
uses
  Classes, SysUtils, fpcunit, testregistry, BaseTestCase, native, BZVectorMath;
...
const
  asmUnitVector : TBZVector4f = (X:1; Y:1; Z:1; W:1);
  natUnitVector : TNativeBZVector4f = (X:1; Y:1; Z:1; W:1);

  asmTwoVector : TBZVector4f = (X:2; Y:2; Z:2; W:2);
  natTwoVector : TNativeBZVector4f = (X:2; Y:2; Z:2; W:2);

  asmHalfVector : TBZVector4f = (X:0.5; Y:0.5; Z:0.5; W:0.5);
  natHalfVector : TNativeBZVector4f = (X:0.5; Y:0.5; Z:0.5; W:0.5);
...
begin
  ...
  infoStr := Format('CPU Info: %s @ %d MHz', [Trim(BZCPUInfos.BrandName), BZCPUInfos.Speed]);
  featuresStr := 'CPU Features: ' + BZCPUInfos.FeaturesAsString;
