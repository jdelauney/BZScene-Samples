...
const
  ...
  c0DegVec :   TBZVector4f = (X:1; Y:0; Z:0; W:0);       // cos 1                      0
  c45DegVec :  TBZVector4f = (X:1; Y:1; Z:0; W:0);       //  0.707106781187            0.7853981634
  c90DegVec :  TBZVector4f = (X:0; Y:1; Z:0; W:0);       //  0                         1.570796
  c135DegVec : TBZVector4f = (X:-1; Y:1; Z:0; W:0);      // -0.707106781187            2.3561945
  c180DegVec : TBZVector4f = (X:-1; Y:0; Z:0; W:0);      // -1                         3.14159265
  c225DegVec : TBZVector4f = (X:-1; Y:-1; Z:0; W:0);     // -0.707106781187            3.92699
  c270DegVec : TBZVector4f = (X:0; Y:-1; Z:0; W:0);      // -0  //this can happen      4.71238898
  c315DegVec : TBZVector4f = (X:1; Y:-1; Z:0; W:0);      //  0.707106781187            5.497787
