...
Type
  ...
  TMainForm = Class(Tform)
    ...
    procedure chkSoundEnvChange(Sender : TObject);
  Private
...
Begin
  ...
  End;
  TBZReverbSoundEffect(SoundFXLibrary.FX.FXItems[0]).Preset := SoundManager.Environment;
End;
...
procedure TMainForm.chkSoundEnvChange(Sender : TObject);
begin
  SoundManager.Sources.Items[0].AuxSlots.Items[0].Activated := not(SoundManager.Sources.Items[0].AuxSlots.Items[0].Activated);
  SoundManager.Sources.Items[0].AuxSlots.Items[0].Gain := 1.0;
end;
